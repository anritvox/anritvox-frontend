  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white text-gray-900 font-inter antialiased py-12 px-4 sm:px-6 lg:px-8">
        ...
        <form className="space-y-4" onSubmit={handleSubmit} autoComplete="off">
          <div>
            ...
            <input
              id="email"
              name="email"
              // MODIFIED: Type is 'text' until focused, then it becomes 'email'
              ...
              autoComplete="off"
              // MODIFIED: onFocus now sets state to change the input type
          ...
          <div>
            ...
            <input
              ...
              onCut={handlePreventCopyPaste}
              onPaste={handlePreventCopyPaste}
              // This should be sufficient for the password field
      ...
      <style>{`
         ...
         .loading-overlay { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(0, 0, 0, 0.4); display: flex; flex-direction: column; align-items: center; justify-content: center; z-index: 9999; backdrop-filter: blur(5px); -webkit-backdrop-filter: blur(5px); animation: overlayFadeIn 0.3s ease-out forwards; }
         @keyframes overlayFadeIn { from { opacity: 0; } to { opacity: 1; } }
         .loading-text { color: white; margin-top: 1rem; font-size: 1.25rem; font-weight: 600; }
         .spinner-3d-container-fullpage { width: 60px; height: 60px; perspective: 150px; display: flex; align-items: center; justify-content: center; }
         .spinner-3d-inner-fullpage { width: 40px; height: 40px; position: relative; transform-style: preserve-3d; animation: rotate3dCube 2.5s infinite ease-in-out; }
         .spinner-3d-inner-fullpage::before, .spinner-3d-inner-fullpage::after { content: ''; position: absolute; width: 100%; height: 100%; border: 4px solid white; box-sizing: border-box; opacity: 0.8; }
         .spinner-3d-inner-fullpage::before { transform: rotateY(0deg) translateZ(20px); animation: spin3dFront 2.5s infinite ease-in-out; }
         .spinner-3d-inner-fullpage::after { transform: rotateY(90deg) translateZ(20px); animation: spin3dSide 2.5s infinite ease-in-out; }
         @keyframes rotate3dCube { 0% { transform: rotateX(0deg) rotateY(0deg) rotateZ(0deg); } 25% { transform: rotateX(90deg) rotateY(45deg) rotateZ(0deg); } 50% { transform: rotateX(180deg) rotateY(90deg) rotateZ(180deg); } 75% { transform: rotateX(270deg) rotateY(135deg) rotateZ(270deg); } 100% { transform: rotateX(360deg) rotateY(180deg) rotateZ(360deg); } }
         @keyframes spin3dFront { 0%, 100% { transform: rotateY(0deg) translateZ(20px); } 50% { transform: rotateY(180deg) translateZ(20px); } }
         @keyframes spin3dSide { 0%, 100% { transform: rotateY(90deg) translateZ(20px); } 50% { transform: rotateY(270deg) translateZ(20px); } }
       `}</style>
    </div>
  );
}
