...
// base_warranty_months: number (e.g. 6, 12, 24, 60) => new-policy serial (is_legacy=false, 14-day rule enforced)
// base_warranty_months: null/undefined => legacy serial (is_legacy=true, old behavior preserved)
export async function addProductSerials(productId, count, prefix = "ANRI", format = "advanced", base_warranty_months = null) {
